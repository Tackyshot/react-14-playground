...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HelloWorld = __webpack_require__(154);

	var _HelloWorld2 = _interopRequireDefault(_HelloWorld);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_HelloWorld2.default, { name: 'Clara' }), document.getElementById("App"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NameModifier = __webpack_require__(155);

	var _NameModifier2 = _interopRequireDefault(_NameModifier);

	var _nameActions = __webpack_require__(156);

	var _nameActions2 = _interopRequireDefault(_nameActions);

	var _nameStores = __webpack_require__(173);

	var _nameStores2 = _interopRequireDefault(_nameStores);
	...
	var HelloWorld = (function (_React$Component) {
	    ...
	    function HelloWorld(props, state) {
	        ...
	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(HelloWorld).call(this, props, state));
	    ...
	    _createClass(HelloWorld, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            _nameActions2.default.get(function () {
	                _this.setState({
	                    name: _nameStores2.default.getState().names
	                });
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_NameModifier2.default, { onBlur: this.handleNameChange })
	            );
	        }
	    }, {
	        ...
	        value: function handleNameChange(e) {
	            ...
	            _nameActions2.default.create(e.target.value, function () {
	                _this2.setState({
	                    name: _nameStores2.default.getState().names
	                });
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NameModifier = (function (_React$Component) {
	    _inherits(NameModifier, _React$Component);

	    function NameModifier(props, state) {
	        _classCallCheck(this, NameModifier);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NameModifier).call(this, props, state));
	    }

	    _createClass(NameModifier, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                null,
	                _react2.default.createElement("input", { type: "text", placeholder: "Change your name here", onBlur: this.props.onBlur }),
	                " ",
	                _react2.default.createElement("input", { type: "submit", name: "submit", id: "submit" })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _superagent = __webpack_require__(157);
	    ...
	    _createClass(NameActions, [{
	        ...
	        value: function get(callback) {
	            ...
	            return function (dispatch) {
	                _superagent2.default.get('/api/names').set('Accept', 'application/json').end(function (err, res) {
	        ...
	        key: 'create',
	        value: function create(name, callback) {

	            console.log("CREATE!!");
	            return function (dispatch) {
	                _superagent2.default.post('/api/names').send({
	                    name: name
	...
	exports.default = _alt2.default.createActions(NameActions);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStateFunctions = __webpack_require__(165);
	...
	var _utilsAltUtils = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltStore = __webpack_require__(169);

	var _AltStore2 = _interopRequireDefault(_AltStore);

	var _StoreMixin = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transmitter = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NameStore = (function () {
	    function NameStore() {
	        _classCallCheck(this, NameStore);

	        this.bindListeners({
	            set: [_nameActions2.default.get, _nameActions2.default.create]
	        });
	    ...
	    _createClass(NameStore, [{
	        key: 'set',
	        value: function set(names) {
	...
	exports.default = _alt2.default.createStore(NameStore);
